...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const enrollButtons = document.querySelectorAll('.program-card .btn');
    
    enrollButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            e.preventDefault();
            const programName = this.closest('.program-card').querySelector('h3').textContent;
            showNotification(`Enrollment for ${programName} will be available soon!`, 'info');
        });
    });
    ...
    const animateElements = document.querySelectorAll('.value-card, .program-card, .blog-card, .about-item');
    ...
    document.addEventListener('keydown', function(e) {
        ...
        if (konamiCode.join(',') === konamiSequence.join(',')) {
            showNotification('🎉 You found the Konami Code! Welcome to HOTI!', 'success');
            konamiCode = [];
        }
    });
    ...
    console.log('🚀 HOTI Website loaded successfully!');
    console.log('Helping Others Through creativity & Innovation');
});